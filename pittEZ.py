...
###>[ BANNER ]<###
def banner():
	basari_tamvan('ﮩ٨ـﮩ' * 10)
	print(f"""{kk}[•] Errere  Multi Brute Force [•]
{m}☠︎☠︎☠︎☠︎☠︎☠︎ ☠︎☠︎ ☠︎☠︎     ☠︎☠︎     
{m}☠︎☠︎  ☠︎☠︎    ☠︎☠︎     ☠︎☠︎     
{m}☠︎☠︎  ☠︎☠︎ ☠︎☠︎ ☠︎☠︎     ☠︎☠︎     
{kk}☠︎☠︎☠︎☠︎☠︎☠︎ ☠︎☠︎ ☠︎☠︎☠︎☠︎☠︎  ☠︎☠︎☠︎☠︎☠︎  ☠︎☠︎☠︎☠︎ ☠︎☠︎☠︎☠︎
{kk}☠︎☠︎     ☠︎☠︎ ☠︎☠︎     ☠︎☠︎     ☠︎☠︎☠︎☠︎  ☠︎ 
{kk}☠︎☠︎     ☠︎☠︎ ☠︎☠︎☠︎☠︎☠︎☠︎ ☠︎☠︎☠︎☠︎☠︎☠︎ ☠︎☠︎☠︎☠︎ ☠︎☠︎☠︎☠︎ {O}•-PittEZ     {P}""")
	basari_tamvan('ﮩ٨ـﮩ' * 10)
...
def menu(my_name,my_id):
	...
	#basari_tamvan(f' Github   : Basari-ID')
	...
	if basari_sayang_syafaa in ['1']:
		...
		back()
def authorbas():
	basari_tamvan(f'{sir}[!] Tunggu Bentar cuk Ntar Diarahin Ke Wa  {x}')
	time.sleep(4)
	os.system("xdg-open wa.me/6285838803658")
	back()
...
if __name__=='__main__':
	...
	try:os.mkdir('/sdcard/ninja.')
	except:pass
	try:os.system('touch .prox.txt')
	except:pass
	try:os.system('clear')
	except:pass
	basari_tamvan(f'\n\t{x} {h}Hai saya Vito Saya Hanya Lulusan Ma Nuha:v{x}')
	time.sleep(3)
	login()
